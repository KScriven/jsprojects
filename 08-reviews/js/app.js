...
// load initial item on document load
...
function showPerson(person) {
  const firstItem = reviews[person];
  img.src = firstItem.img;
  author.textContent = firstItem.author;
  job.textContent = firstItem.job;
  info.textContent = firstItem.text;
}
